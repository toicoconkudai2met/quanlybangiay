...
(1,'Nguyen Van A', '0909123456', '1980-01-01', '123 Đường A, TP. HCM'),
(2,'Tran Thi B', '0909345678', '1985-02-02', '456 Đường B, TP. HCM'),
(3,'Le Van C', '0909567890', '1990-03-03', '789 Đường C, TP. HCM'),
(4,'Pham Thi D', '0909789012', '1995-04-04', '321 Đường D, TP. HCM'),
(5,'Hoang Van E', '0909901234', '2000-05-05', '654 Đường E, TP. HCM');

-- Insert data into KhachHang
INSERT INTO KhachHang (SDTKH, TenKhachHang, NgaySinh, DiaChi) VALUES
('0912345678', 'Nguyen Thi X', '1980-01-01', '12 Đường X, TP. HCM'),
('0912345679', 'Tran Van Y', '1985-02-02', '34 Đường Y, TP. HCM'),
('0912345680', 'Le Thi Z', '1990-03-03', '56 Đường Z, TP. HCM'),
('0912345681', 'Pham Van W', '1995-04-04', '78 Đường W, TP. HCM'),
('0912345682', 'Hoang Thi V', '2000-05-05', '90 Đường V, TP. HCM');

-- Insert data into HoaDon
INSERT INTO HoaDon (MaHoaDon, NgayTao, GhiChu, TrangThai, SDTKH, MaNhanVien) VALUES
(1, '2023-01-01', 'Khách hàng thanh toán tiền mặt', 'Đã thanh toán', '0912345678', 1),
(2, '2023-01-15', 'Chuyển khoản ngân hàng', 'Đã thanh toán', '0912345679', 2),
(3, '2023-02-10', 'Thanh toán thẻ tín dụng', 'Đã thanh toán', '0912345680', 3),
(4, '2023-02-20', 'Khách hàng yêu cầu xuất hóa đơn', 'Chưa thanh toán', '0912345681', 4),
(5, '2023-03-05', 'Thanh toán sau khi nhận hàng', 'Đang xử lý', '0912345682', 5);
...
(10, '(HÀNG VNXK)Giày đá bóng chính hãng thăng Long');
